...
package com.example.cervixcenter.Ai.java.cameraca;
...
public class CameraCalibrationActivity extends CameraActivity implements CvCameraViewListener2, OnTouchListener {
    ...
    private org.opencv.samples.cameracalibration.CameraCalibrator mCalibrator;
    private org.opencv.samples.cameracalibration.OnCameraFrameRender mOnCameraFrameRender;
    private Menu mMenu;
    private int mWidth;
    private int mHeight;
    ...
    public void onCameraViewStarted(int width, int height) {
        if (mWidth != width || mHeight != height) {
            mWidth = width;
            mHeight = height;
            mCalibrator = new org.opencv.samples.cameracalibration.CameraCalibrator(mWidth, mHeight);
